...
<script src="../static/style/js/login.js"></script>
<link rel="stylesheet" href="../static/style/css/amazeui.min.css">
<link rel="stylesheet" href="../static/style/css/course.css">
<link rel="stylesheet" href="../static/style/css/admin.css">
<script src="../static/style/js/loginandregist.js"></script>
<script src="../static/style/js/jquery-2.1.4.min.js"></script>
<script src="../static/style/js/amazeui.min.js"></script>
		...
		<c:forEach var="review" items="${reviews}" varStatus="status">
			<div
				...
				<div
					...
					<img alt="" src="../static/style/image/vi.JPG">
					</c:if>
					<c:if test="${review.vip==1 }">
					<img alt="" src="../static/style/image/vip.JPG">
					</c:if>
